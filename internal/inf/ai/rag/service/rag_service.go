...
type RAGServiceImpl struct {
	...
	retriever   *components2.RAGRetriever
	vectorStore components2.VectorStore
	processor   *components2.DocumentProcessor
...
func NewRAGService(
	...
	retriever := components2.NewRAGRetriever(vectorStore, cfg)
	processor := components2.NewDocumentProcessor(cfg)
